...
const Home = () => {
    ...
    return (
      <>
<div className={` bg-gradient-to-r from-blue-500 to-green-500 w-full h-16${isMenuOpen?"backdrop-blur-sm blur-sm":""}`}>
...
<div className="relative h-auto overflow-hidden bg-indigo-900">
    ...
    <div className="container relative z-10 flex items-center px-6 py-4 mx-auto md:px-12 xl:py-20">
